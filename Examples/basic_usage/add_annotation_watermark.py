...
#         text_watermark.horizontal_alignment = gwс.HorizontalAlignment.LEFT
#         text_watermark.vertical_alignment = gwс.VerticalAlignment.TOP
#         watermarker.add(text_watermark, options)

#         # Add image watermark
#         with gww.ImageWatermark(test_files.LogoPng) as image_watermark:
#             image_watermark.horizontal_alignment = gwс.HorizontalAlignment.RIGHT
#             image_watermark.vertical_alignment = gwс.VerticalAlignment.TOP
